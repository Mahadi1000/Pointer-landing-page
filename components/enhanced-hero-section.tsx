    ...
    <section className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4 w-full h-[400px] md:w-[1220px] md:h-[600px] lg:h-[810px] md:px-0">
        ...
        <motion.div
          ...
          animate={{
            background: [
              ...
              "radial-gradient(circle at 80% 50%, hsl(var(--accent-purple) / 0.1) 0%, transparent 50%)",
              "radial-gradient(circle at 50% 20%, hsl(var(--neon-cyan) / 0.1) 0%, transparent 50%)",
            ],
          }}
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-medium text-foreground">Trusted by 10,000+ developers</span>
        </motion.div>
        ...
        >
          Accelerate your development workflow with intelligent AI agents that write, review, and optimize your code in
          real-time.
        </motion.p>
