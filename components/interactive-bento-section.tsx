...
const InteractiveBentoCard = ({ title, description, Component, index }: { title: string; description: string; Component: React.FC; index: number }) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 rounded-3xl"
        animate={{
          boxShadow: isHovered ? "0 0 40px hsl(var(--primary) / 0.2)" : "0 0 0px hsl(var(--primary) / 0)",
        }}
        transition={{ duration: 0.3 }}
      />
      ...
      <div className="self-stretch p-6 flex flex-col justify-start items-start gap-2 relative z-10">
        <motion.div
          ...
          transition={{ duration: 0.3 }}
        >
          <p className="self-stretch text-foreground text-xl font-semibold leading-7">{title}</p>
          <p className="self-stretch text-muted-foreground text-base leading-6">{description}</p>
        </motion.div>
      </div>
  ...
  const cards = [
    {
      ...
      description: "Get real-time, smart suggestions for cleaner code with advanced AI analysis.",
      Component: AiCodeReviews,
    },
    {
      title: "Real-time coding previews",
      description: "Chat, collaborate, and instantly preview changes together in real-time.",
      Component: RealtimeCodingPreviews,
    },
    {
      title: "One-click integrations",
      description: "Easily connect your workflow with popular dev tools and services.",
      Component: OneClickIntegrationsIllustration,
    },
    {
      title: "Flexible MCP connectivity",
      description: "Effortlessly manage and configure MCP server access across your stack.",
      Component: MCPConnectivityIllustration,
    },
    {
      title: "Launch parallel coding agents",
      description: "Solve complex problems faster with multiple AI agents working simultaneously.",
      Component: ParallelCodingAgents,
    },
    {
      title: "Deployment made easy",
      description: "Go from code to live deployment on Vercel instantly with zero configuration.",
        ...
        >
          <div className="flex flex-col justify-start items-center gap-6">
            ...
            <p className="w-full max-w-[600px] text-center text-muted-foreground text-lg md:text-xl font-medium leading-relaxed">
              Experience the future of development with AI agents that understand your code, collaborate in real-time,
              and streamline your entire workflow.
            </p>
          </div>
        </motion.div>
